...
- 최근 매매 기록이 주어지면 '계획 vs 행동'의 갭을 점검하세요: 이전 일지의
...
- 토론 발언에 각주([1] 등)와 출처 목록이 있으면 그 근거를 일지에도 살리세요.
  일지 맨 끝에 '## 출처' 섹션을 두고, 인용한 브리핑 섹션·매체명을 목록으로 정리하세요
  (예: '- 브리핑 · 동적 클러스터', '- 실적 시즌 요약 (Bloomberg)').
  근거로 쓴 게 없으면 이 섹션은 생략합니다.
